...
// ─────────────────────────────────────────────
const annBadge = { info: 'info', success: 'success', warning: 'warning', danger: 'danger' }

const SystemSettings = () => {
  const [activeTab, setActiveTab] = useState('general')
  const [features, setFeatures] = useState(adminSystemFeatures)
    ...
    <div className="d-flex flex-column gap-4">
      ...
      <div className="d-flex flex-wrap gap-1 border-bottom border-app-subtle pb-0">
        {TABS.map(({ key, label, icon: Icon }) => (
          <button
            ...
            style={{ borderBottomWidth: activeTab === key ? '2px' : '0', marginBottom: '-1px' }}
          >
            <Icon size={14} />
      ...
      {activeTab === 'general' && (
        <div className="row g-4">
          <div className="col-lg-7">
            <Card>
              <h6 className="fw-semibold text-app-primary mb-4">Platform Configuration</h6>
              <Input label="Support Email" placeholder="support@trackfin.com" defaultValue="support@trackfin.com" />
              <Input label="Platform Name" placeholder="TrackFin" defaultValue="TrackFin" />
              <Input label="Default Currency" placeholder="USD" defaultValue="USD" />
              <Input label="Billing Cycle" placeholder="Monthly" defaultValue="Monthly" />
              <div className="mb-3">
                <ToggleRow
      ...
      {activeTab === 'email' && (
        <div className="row g-4">
          <div className="col-lg-7">
            <Card>
              <h6 className="fw-semibold text-app-primary mb-4">SMTP / Email Configuration</h6>
              <div className="row g-3 mb-3">
                <div className="col-md-8">
                  <Input label="SMTP Host" placeholder="smtp.mailgun.org" defaultValue="smtp.mailgun.org" />
                </div>
                <div className="col-md-4">
                  <Input label="Port" placeholder="587" defaultValue="587" />
                </div>
              </div>
              <Input label="SMTP Username" placeholder="postmaster@trackfin.com" />
              <Input label="SMTP Password" type="password" placeholder="••••••••" />
              <Input label="From Address" placeholder="no-reply@trackfin.com" defaultValue="no-reply@trackfin.com" />
              <Input label="From Name" placeholder="TrackFin" defaultValue="TrackFin" />
      ...
      {activeTab === 'announcements' && (
        <div className="d-flex flex-column gap-3">
          ...
          {showAnnForm && (
            <Card>
              <h6 className="fw-semibold text-app-primary mb-3">Create Announcement</h6>
              <div className="mb-3">
                <label className="form-label small text-app-secondary">Title</label>
                <input
              ...
              <div className="mb-3">
                <label className="form-label small text-app-secondary">Message</label>
                <textarea
                  className="form-control rounded-3"
                  rows={3}
              ...
              <div className="d-flex align-items-start gap-3">
                <div className="flex-grow-1 min-w-0">
                  <div className="d-flex align-items-center gap-2 mb-1">
                    <p className="fw-semibold text-app-primary mb-0">{ann.title}</p>
                  ...
                  <p className="small text-app-muted mb-0">Created: {ann.createdAt}</p>
                </div>
                <button
                  type="button"
      ...
      {activeTab === 'maintenance' && (
        <div className="row g-4">
          <div className="col-lg-7">
            {maintenance && (
              <div className="alert alert-warning d-flex align-items-center gap-2 rounded-3 mb-0" role="alert">
                <Wrench size={18} />
                <div>
                  <strong>Maintenance mode is ON.</strong> All users will see a maintenance page until you disable this.
                </div>
              </div>
            )}
            <Card className="mt-3">
              <h6 className="fw-semibold text-app-primary mb-4">Maintenance Mode</h6>
              <ToggleRow
              ...
              <div className="d-flex justify-content-end mt-4">
                <Button
                  ...
                  onClick={() => toast.success(maintenance ? 'Maintenance mode enabled.' : 'Maintenance mode disabled.')}
                >
                  {maintenance ? 'Apply Maintenance Mode' : 'Maintenance Mode Off'}
                </Button>
              </div>
            </Card>
          </div>
      ...
      {activeTab === 'security' && (
        <div className="row g-4">
          <div className="col-lg-7">
            <Card>
              <h6 className="fw-semibold text-app-primary mb-4">Security Policy</h6>
              ...
              <Input label="Session Timeout (minutes)" placeholder="60" defaultValue="60" />
              <Input label="Max Login Attempts" placeholder="5" defaultValue="5" />
