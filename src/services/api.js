...
export const AUTH_GOOGLE_LOGIN_ENDPOINT = "/trackfin/auth/google";
...
export const ADMIN_BROADCAST_ENDPOINT = "/trackfin/admin/broadcast/send";
export const ADMIN_BROADCAST_HISTORY_ENDPOINT = "/trackfin/admin/broadcast/history";
